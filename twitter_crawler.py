...
class TwitterClient(object):
    def __init__(self, query, retweets_only=False, with_sentiment=False):
        ...
        access_token = '3720728952-zBkjKHV6EIzOtbnuZz4M4kpUuf0rLe9lBCjtdqG'
        access_token_secret = 'q5lqi72PFLZU6YALPXk5tFfB3p8maXabeEe1hbkTmfPZE'
        ...
        try:
            ...
            self.tweet_count_max = 5  # To prevent Rate Limiting
        except:
